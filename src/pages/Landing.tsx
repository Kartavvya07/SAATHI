...
function HeroVisual() {
  return (
    <div className="relative flex items-center justify-center min-h-[420px] sm:min-h-[480px] lg:min-h-[540px] w-full animate-fade-up [animation-delay:120ms]">
      {/* 3D Knowledge Network Constellation */}
      <ConstellationShell
